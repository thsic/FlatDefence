...
global.effectdata[target, effectdata.description] = "敵を倒すとクールダウンが@40%解消される";
...
global.effectdata[target, effectdata.description] = "あらゆる攻撃でスロー@を与えるようになる";
global.effectdata[target, effectdata.value] = 0;
global.effectdata[target, effectdata.overlap] = false;
global.effectdata[target, effectdata.color] = COLOR_TEXT_BLUE;
...
global.effectdata[target, effectdata.description] = "敵のシールドを追加で3削る";
global.effectdata[target, effectdata.value] = 3;
global.effectdata[target, effectdata.overlap] = true;
global.effectdata[target, effectdata.color] = COLOR_TEXT_BLUE;
global.effectdata[target, effectdata.addeffect] = -1;
...
global.effectdata[target, effectdata.description] = "爆風の中心の敵は@狙った敵として処理される";
global.effectdata[target, effectdata.value] = 2;
global.effectdata[target, effectdata.overlap] = false;
global.effectdata[target, effectdata.color] = COLOR_TEXT_BLUE;
global.effectdata[target, effectdata.addeffect] = -1;
...
global.effectdata[target, effectdata.description] = "攻撃が当たった時ゴールドを1%消費する@消費したゴールドx10の追加ダメージ";//狙った敵のみ
...
global.effectdata[target, effectdata.description] = "敵のHPが奇数なら@Power0.3倍の追加ダメージ";//狙った敵のみ
global.effectdata[target, effectdata.value] = 1;
global.effectdata[target, effectdata.overlap] = true;
global.effectdata[target, effectdata.color] = COLOR_TEXT_BLUE;
global.effectdata[target, effectdata.addeffect] = -1;
