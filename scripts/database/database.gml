...
global.defender_data[target, data.description] = "攻撃が当たった敵の速度を下げる";
global.defender_data[target, data.damage] = 50;
global.defender_data[target, data.attack_speed] = 1;
global.defender_data[target, data.range] = 100;
global.defender_data[target, data.cost] = 140;
global.defender_data[target, data.itemslot] = 3;
...
global.defender_data[target, data.description] = "敵を倒すと5ゴールド入手できる";
global.defender_data[target, data.damage] = 40;
global.defender_data[target, data.attack_speed] = 1.5;
global.defender_data[target, data.range] = 100;
global.defender_data[target, data.cost] = 80;
global.defender_data[target, data.itemslot] = 3;
...
global.itemdata[target, itemdata.range] = 0;
global.itemdata[target, itemdata.cost] = 60;
...
global.itemdata[target, itemdata.attack_speed] = 0;
global.itemdata[target, itemdata.range] = 0;
global.itemdata[target, itemdata.cost] = 120;
...
global.enemydata[target, enemydata.hp] = 170;
global.enemydata[target, enemydata.shield] = 45;
global.enemydata[target, enemydata.speed] = 4.7;
global.enemydata[target, enemydata.description] = "";
...
global.enemydata[target, enemydata.description] = "スローを半減する";
global.enemydata[target, enemydata.dropgold] = 12;
...
global.enemydata[target, enemydata.hp] = 250;
...
global.enemydata[target, enemydata.hp] = 700;
global.enemydata[target, enemydata.shield] = 250;
global.enemydata[target, enemydata.speed] = 1.3;
global.enemydata[target, enemydata.description] = "スローを半減する";
...
global.enemydata[target, enemydata.hp] = 300;
...
global.enemydata[target, enemydata.hp] = 950;
global.enemydata[target, enemydata.shield] = 40;
...
global.enemydata[target, enemydata.hp] = 1800;
global.enemydata[target, enemydata.shield] = 100;
global.enemydata[target, enemydata.speed] = 1.3;
global.enemydata[target, enemydata.description] = "スローを半減する";
...
global.enemydata[target, enemydata.hp] = 100;
global.enemydata[target, enemydata.shield] = 10;
global.enemydata[target, enemydata.speed] = 1.4;
global.enemydata[target, enemydata.description] = "常に自己再生している@スローを半減する";
global.enemydata[target, enemydata.dropgold] = 16;
...
global.enemydata[target, enemydata.description] = "ライフを3減らす@スローを3分の1にする";
...
global.enemydata[target, enemydata.name] = "BOSS";
global.enemydata[target, enemydata.hp] = 4500;
...
global.effectdata[target, effectdata.description] = "爆風の中心はダメージが2倍@になる";
global.effectdata[target, effectdata.value] = 2;
global.effectdata[target, effectdata.overlap] = false;
global.effectdata[target, effectdata.color] = COLOR_TEXT_BLUE;
global.effectdata[target, effectdata.addeffect] = -1;
...
global.effectdata[target, effectdata.description] = "1秒間攻撃しないでいると@次の弾のダメージが3倍になる";
global.effectdata[target, effectdata.value] = 3;
global.effectdata[target, effectdata.overlap] = false;
global.effectdata[target, effectdata.color] = COLOR_TEXT_BLUE;
global.effectdata[target, effectdata.addeffect] = -1;
...
global.effectdata[target, effectdata.description] = "敵を倒した時の獲得Gが2倍になる@(このGはスコアには加算されない)";
global.effectdata[target, effectdata.value] = 1;
global.effectdata[target, effectdata.overlap] = false;
global.effectdata[target, effectdata.color] = COLOR_TEXT_BLUE;
global.effectdata[target, effectdata.addeffect] = -1;
...
global.effectdata[target, effectdata.description] = "敵を倒すと追加で5Gを得る";
...
global.effectdata[target, effectdata.description] = "弾が当たった敵のHPが最大なら@パワーx0.4の追加ダメージ";//狙った敵のみ
global.effectdata[target, effectdata.value] = 0.4;
global.effectdata[target, effectdata.overlap] = false;
global.effectdata[target, effectdata.color] = COLOR_TEXT_BLUE;
global.effectdata[target, effectdata.addeffect] = -1;
