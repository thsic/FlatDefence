...
global.defender_data[target, data.description] = "ステータスが低いがアイテム枠が多い";
...
global.defender_data[target, data.attack_speed] = 0.4;
...
global.defender_data[target, data.description] = "敵の速度を下げれる";
...
global.effectdata[target, effectdata.description] = "敵にダメージを与えると爆風が発生する 爆風は0.25倍の炎ダメージになる";
...
global.effectdata[target, effectdata.description] = "狙った敵のみ 敵の速度を下げる 速度低下時間は攻撃力参照";
global.effectdata[target, effectdata.value] = 0;
global.effectdata[target, effectdata.overlap] = true;
global.effectdata[target, effectdata.color] = COLOR_TEXT_BLUE;
...
global.effectdata[target, effectdata.description] = "あらゆるダメージが5上昇する";
...
global.effectdata[target, effectdata.description] = "敵を倒すと攻撃のクールダウンが40%解消される";
...
global.effectdata[target, effectdata.description] = "あらゆる攻撃でスローを与えるようになる";
global.effectdata[target, effectdata.value] = 0;
global.effectdata[target, effectdata.overlap] = false;
global.effectdata[target, effectdata.color] = COLOR_TEXT_BLUE;
...
global.effectdata[target, effectdata.description] = "敵のシールドを追加でlv*3削る";
global.effectdata[target, effectdata.value] = 3;
global.effectdata[target, effectdata.overlap] = true;
global.effectdata[target, effectdata.color] = COLOR_TEXT_BLUE;
global.effectdata[target, effectdata.addeffect] = -1;
...
global.effectdata[target, effectdata.description] = "爆風の中心の敵に対してダメージが1.5倍になる";
...
global.effectdata[target, effectdata.description] = "ベーシックソードが自動的にアップグレードされる";
global.effectdata[target, effectdata.value] = 0;
global.effectdata[target, effectdata.overlap] = false;
global.effectdata[target, effectdata.color] = COLOR_TEXT_BLUE;
global.effectdata[target, effectdata.addeffect] = -1;
...
target = 25;
global.effectdata[target, effectdata.number] = target;
global.effectdata[target, effectdata.name] = "ワンショット・ワンキル";
global.effectdata[target, effectdata.description] = "射程250以上離れた敵に対してダメージが2倍になる";
global.effectdata[target, effectdata.value] = 2;
global.effectdata[target, effectdata.overlap] = false;
global.effectdata[target, effectdata.color] = COLOR_TEXT_BLUE;
global.effectdata[target, effectdata.addeffect] = -1;
...
global.effectdata[target, effectdata.description] = "爆風の中心の敵は狙った敵として処理される";
global.effectdata[target, effectdata.value] = 2;
global.effectdata[target, effectdata.overlap] = false;
global.effectdata[target, effectdata.color] = COLOR_TEXT_BLUE;
global.effectdata[target, effectdata.addeffect] = -1;
...
global.effectdata[target, effectdata.description] = "1秒毎に射程内の敵すべてに0.2倍のダメージが発生";
global.effectdata[target, effectdata.value] = 0.2;
global.effectdata[target, effectdata.overlap] = false;
global.effectdata[target, effectdata.color] = COLOR_TEXT_BLUE;
global.effectdata[target, effectdata.addeffect] = -1;
...
global.effectdata[target, effectdata.description] = "狙った敵のみ 攻撃が当たった時ゴールドを1%消費する@消費したゴールドx10の追加ダメージ";
...
global.effectdata[target, effectdata.description] = "狙った敵のみ 敵のHPが奇数なら0.3倍の追加ダメージをlv回発生";
global.effectdata[target, effectdata.value] = 1;
global.effectdata[target, effectdata.overlap] = true;
global.effectdata[target, effectdata.color] = COLOR_TEXT_BLUE;
global.effectdata[target, effectdata.addeffect] = -1;
...
global.effectdata[target, effectdata.description] = "狙った敵のみ 敵のHPが最大なら0.4倍の追加ダメージが発生";
global.effectdata[target, effectdata.value] = 0.4;
global.effectdata[target, effectdata.overlap] = false;
global.effectdata[target, effectdata.color] = COLOR_TEXT_BLUE;
global.effectdata[target, effectdata.addeffect] = -1;
...
global.effectdata[target, effectdata.description] = "狙った敵のみ 敵のHPが最大なら1倍の追加ダメージが発生";
global.effectdata[target, effectdata.value] = 1;
global.effectdata[target, effectdata.overlap] = false;
global.effectdata[target, effectdata.color] = COLOR_TEXT_BLUE;
global.effectdata[target, effectdata.addeffect] = -1;
