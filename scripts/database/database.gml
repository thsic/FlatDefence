...
global.defender_data[target, data.attack_speed] = 0.8;
...
global.effectdata[target, effectdata.description] = "攻撃がシールドを無視する";
global.effectdata[target, effectdata.value] = 0;
...
global.effectdata[target, effectdata.description] = "狙った敵の速度を遅くする @効果時間はパワーに比例する";//狙った敵のみ
global.effectdata[target, effectdata.value] = 0;
global.effectdata[target, effectdata.overlap] = true;
global.effectdata[target, effectdata.color] = COLOR_TEXT_BLUE;
...
global.effectdata[target, effectdata.description] = "攻撃で与えるダメージが0.1倍になる";//スキル以外でダメージを与えられない
global.effectdata[target, effectdata.value] = 0;
global.effectdata[target, effectdata.overlap] = false;
...
global.effectdata[target, effectdata.description] = "弾が敵を3体まで貫通する";
...
global.effectdata[target, effectdata.description] = "攻撃がシールドを追加で\v削る";
global.effectdata[target, effectdata.value] = 3;
global.effectdata[target, effectdata.overlap] = true;
global.effectdata[target, effectdata.color] = COLOR_TEXT_BLUE;
global.effectdata[target, effectdata.addeffect] = -1;
...
global.effectdata[target, effectdata.description] = "弾速と連射速度が上昇する";
global.effectdata[target, effectdata.value] = 0;
global.effectdata[target, effectdata.overlap] = false;
global.effectdata[target, effectdata.color] = COLOR_TEXT_BLUE;
global.effectdata[target, effectdata.addeffect] = -1;
...
global.effectdata[target, effectdata.description] = "射程250以上離れた敵に対して@弾のダメージが2倍になる";
global.effectdata[target, effectdata.value] = 2;
global.effectdata[target, effectdata.overlap] = false;
global.effectdata[target, effectdata.color] = COLOR_TEXT_BLUE;
global.effectdata[target, effectdata.addeffect] = -1;
...
global.effectdata[target, effectdata.description] = "狙った敵のHPが奇数ならパワーx0.3@の追加ダメージが\l回発生";//狙った敵のみ
global.effectdata[target, effectdata.value] = 1;
global.effectdata[target, effectdata.overlap] = true;
global.effectdata[target, effectdata.color] = COLOR_TEXT_BLUE;
global.effectdata[target, effectdata.addeffect] = -1;
...
global.effectdata[target, effectdata.description] = "狙った敵のHPが最大なら@パワーx0.4の追加ダメージ";//狙った敵のみ
global.effectdata[target, effectdata.value] = 0.4;
global.effectdata[target, effectdata.overlap] = false;
global.effectdata[target, effectdata.color] = COLOR_TEXT_BLUE;
global.effectdata[target, effectdata.addeffect] = -1;
...
global.effectdata[target, effectdata.description] = "狙った敵のHPが最大なら@パワーx1の追加ダメージ";//狙った敵のみ
global.effectdata[target, effectdata.value] = 1;
global.effectdata[target, effectdata.overlap] = false;
global.effectdata[target, effectdata.color] = COLOR_TEXT_BLUE;
global.effectdata[target, effectdata.addeffect] = -1;
