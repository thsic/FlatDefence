...
case 0:
	...
	draw_text(offset_x+6, offset_y+4, global.defender_data[target_id, data.name]);
	draw_text(offset_x+150, offset_y+24, global.defender_data[target_id, data.damage]);
	draw_text(offset_x+150, offset_y+48, global.defender_data[target_id, data.attack_speed]);
	draw_text(offset_x+150, offset_y+72, global.defender_data[target_id, data.range]);
	
	draw_set_color(COLOR_TEXT_YELLOW);
	draw_set_halign(fa_right);
	draw_text(offset_x+window_width-6, offset_y+4, global.defender_data[target_id, data.cost]);
