...
var ui_y = view_hport[0]-36-rectangle_height;
...
draw_music_width = SHOP_WINDOW_WIDTH-2;
//下に少し暗めの四角を敷く
...
draw_sprite(s_musicNowplay, 0, view_wport[0]-draw_music_width, ui_y+8)
draw_sprite(s_musicCreator, 0, view_wport[0]-draw_music_width, ui_y+22)
draw_text(view_wport[0]-draw_music_width+13, ui_y+8, music_name);
//draw_text_scroll(view_wport[0]-draw_music_width+12, 6, music_name, 120);
draw_text(view_wport[0]-draw_music_width+12, ui_y+22, music_creator);
...
draw_rectangle(view_wport[0]-draw_music_width, ui_y+0, view_wport[0]-draw_music_width+rectangle_width, ui_y+0+rectangle_height, false);
